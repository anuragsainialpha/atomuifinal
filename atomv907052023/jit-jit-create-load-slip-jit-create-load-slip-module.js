(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["jit-jit-create-load-slip-jit-create-load-slip-module"],{

/***/ "./src/app/jit/jit-create-load-slip/jit-create-load-slip.component.html":
/*!******************************************************************************!*\
  !*** ./src/app/jit/jit-create-load-slip/jit-create-load-slip.component.html ***!
  \******************************************************************************/
...
/***/ "./src/app/jit/jit-create-load-slip/jit-create-load-slip.component.ts":
/*!****************************************************************************!*\
  !*** ./src/app/jit/jit-create-load-slip/jit-create-load-slip.component.ts ***!
  \****************************************************************************/
/*! exports provided: JitCreateLoadSlipComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JitCreateLoadSlipComponent", function() { return JitCreateLoadSlipComponent; });
...
var JitCreateLoadSlipComponent = /** @class */ (function () {
    function JitCreateLoadSlipComponent(service, router, ActivatedRoute, toastr, dialog) {
        ...
        this.displayedColumns = ['select', 'invoiceNumber', 'deliveryNumber', 'destLoc', 'invoiceDate', 'billTo', 'billToName', 'shipTo', 'shipToName'];
    ...
    JitCreateLoadSlipComponent.prototype.ngOnInit = function () {
    ...
    JitCreateLoadSlipComponent.prototype.getInvoicesMDInvoces = function () {
        var _this = this;
        this.isLoading = true;
        var data = {
        ...
        this.service.post_service(_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_1__["ApiserviceService"].apisList.getLoadSlipUtlizationsForExport, data).subscribe(function (response) {
            if (response['statusCode'] == 200) {
                ...
                _this.destination = _this.isMDROP;
                ...
                _this.description = _this.loadslipUtilizationData.destDesc;
    ...
    JitCreateLoadSlipComponent.prototype.getOpenDestinations = function () {
        var _this = this;
        if (this.loadslipID || (this.isShareTruck)) {
            this.isLoading = true;
            this.service.get_service(_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_1__["ApiserviceService"].apisList.getExportDestination).subscribe(function (response) {
                if (response['statusCode'] == 200) {
                    var responseData = response['data'];
                    _this.mdLoc = responseData;
                    if (!_this.isShareTruck) {
    ...
    JitCreateLoadSlipComponent.prototype.getLoadSlipUtilizationsForJITShareTuck = function (shipmentNumber) {
        var _this = this;
        this.isLoading = true;
        var data = {
    ...
    // Check multi stop 
    JitCreateLoadSlipComponent.prototype.checkMultiStop = function () {
    ...
    JitCreateLoadSlipComponent.prototype.loadslipOnSameTruckNavigation = function () {
    ...
    JitCreateLoadSlipComponent.prototype.shareTruckDestinationList = function () {
        var _this = this;
        this.isLoading = true;
    ...
    JitCreateLoadSlipComponent.prototype.shareTruck = function () {
        var _this = this;
        this.isLoading = true;
    ...
    JitCreateLoadSlipComponent.prototype.getvariants = function () {
        var _this = this;
        //this.isLoading = true;
    ...
    JitCreateLoadSlipComponent.prototype.getActualTruckTypeList = function () {
        var _this = this;
    ...
    JitCreateLoadSlipComponent.prototype.getGateInContainer = function () {
        var _this = this;
        this.isLoading = true;
        this.service.get_service(_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_1__["ApiserviceService"].apisList.getExportGateInContainer + "?type=JIT_OEM&loadslipId=").subscribe(function (response) {
            if (response['statusCode'] == 200) {
                var responseData = response['data'];
    ...
    JitCreateLoadSlipComponent.prototype.getLoadSlipDetailsById = function () {
        var _this = this;
    ...
    // for getting container and truck list based on loadslip id
    JitCreateLoadSlipComponent.prototype.getContainerListBaseLoadslipId = function (responseData) {
        var _this = this;
        this.service.get_service(_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_1__["ApiserviceService"].apisList.getExportGateInContainer + "?type=JIT_OEM&loadslipId=" + this.loadslipID).subscribe(function (response) {
            if (response['statusCode'] == 200) {
                ...
                _this.getLoadSlipUtilizationsForJIT(respData.TRUCK_NUMBER, respData.TRUCK_TYPE, _this.shipmentNumber);
                // this.isLoading = false;
                // Set table data
    ...
    JitCreateLoadSlipComponent.prototype.getLoadSlipUtilizationsForJIT = function (truckNumber, truckType, shipmentNumber) {
        var _this = this;
        this.isLoading = true;
        var data = {
    ...
    // for sertting 
    JitCreateLoadSlipComponent.prototype.setLoadSlipDraftData = function (responseData) {
        var _this = this;
        // this.isLoading = true;
    ...
    JitCreateLoadSlipComponent.prototype.onPageSizeChanged = function (event) {
        this.page.limit = event;
        this.page.pageSize = this.pageSize;
    };
    // get Load slip Utilizations 
    JitCreateLoadSlipComponent.prototype.getLoadSlipUtilazationForJITBasedOnTruck = function (truckNumber) {
        var _this = this;
        this.isLoading = true;
        // this.clearFields();
        var trackingObj = this.truckTypes.find(function (truckObj) { return truckObj.TRUCK_NUMBER == truckNumber; });
        var respData = trackingObj;
    ...
    JitCreateLoadSlipComponent.prototype.ManualTTE_Weight_volume_Calculation = function () {
    ...
    JitCreateLoadSlipComponent.prototype.eventCall = function (loadSlipID, eventType) {
        var _this = this;
        if (loadSlipID) {
            this.isLoading = true;
            var data = {
    ...
    JitCreateLoadSlipComponent.prototype.saveAsDraft_Print_trigger = function (eventType) {
        this.isLoading = true;
        var linenumber;
    ...
    // }
    // for saving load slip for jit in draft mode
    JitCreateLoadSlipComponent.prototype.saveAsDrafJIT = function (saveasDraftData, httpAPI) {
        var _this = this;
        this.isLoading = true;
    ...
    JitCreateLoadSlipComponent.prototype.openloadsliperrorPopup = function (errorList) {
    ...
    JitCreateLoadSlipComponent.prototype.showLoadslipInModal = function (value, typeofevent, IsUpdate, response) {
    ...
    JitCreateLoadSlipComponent.prototype.clearFields = function () {
        if (!this.checkMultiStop()) {
    ...
    JitCreateLoadSlipComponent.prototype.cancelLoadslipCreation = function () {
        var _this = this;
        this.isLoading = true;
    ...
    JitCreateLoadSlipComponent.prototype.downloadLoadslip = function () {
        var _this = this;
        this.isLoading = true;
    ...
    JitCreateLoadSlipComponent.prototype.isAllSelected = function () {
        if (this.viewType) {
    ...
    JitCreateLoadSlipComponent.prototype.masterToggle = function () {
        var _this = this;
        if (this.viewType) {
    ...
    JitCreateLoadSlipComponent.prototype.confirmInvoice = function () {
        var _this = this;
    ...
    JitCreateLoadSlipComponent.prototype.getTruckTypesForDest = function (destination) {
        var _this = this;
        if (destination) {
    ...
    JitCreateLoadSlipComponent.prototype.onOpenModal = function () {
        var _this = this;
        ...
        this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_9__["SelectionModel"](true, selectedItems);
        // }
        $('#myModal').modal('show');
    };
    JitCreateLoadSlipComponent.prototype.weightSummaryCell = function () {
        var _this = this;
    ...
    // Print Excel
    JitCreateLoadSlipComponent.prototype.export = function () {
        var _this = this;
        this.isLoading = true;
    ...
    JitCreateLoadSlipComponent.prototype.lsOnSameTruck = function (dropLoc) {
        if (dropLoc) {
    ...
    JitCreateLoadSlipComponent.prototype.getInvoices = function (destination) {
    ...
    ], JitCreateLoadSlipComponent.prototype, "weSummaryCell", void 0);
    JitCreateLoadSlipComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-jit-create-load-slip',
            template: __webpack_require__(/*! ./jit-create-load-slip.component.html */ "./src/app/jit/jit-create-load-slip/jit-create-load-slip.component.html")
        }),
    ...
    return JitCreateLoadSlipComponent;
}());
...
/*!*************************************************************************!*\
  !*** ./src/app/jit/jit-create-load-slip/jit-create-load-slip.module.ts ***!
  \*************************************************************************/
/*! exports provided: JitCreateLoadSlipModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JitCreateLoadSlipModule", function() { return JitCreateLoadSlipModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var src_app_public_share_module_share_module_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/public/share-module/share-module.module */ "./src/app/public/share-module/share-module.module.ts");
/* harmony import */ var src_app_public_loadslip_cancel_popup_loadslip_cancel_popup_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/public/loadslip-cancel-popup/loadslip-cancel-popup.component */ "./src/app/public/loadslip-cancel-popup/loadslip-cancel-popup.component.ts");
/* harmony import */ var src_app_public_loadslip_success_dialog_loadslip_success_dialog_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/public/loadslip-success-dialog/loadslip-success-dialog.component */ "./src/app/public/loadslip-success-dialog/loadslip-success-dialog.component.ts");
/* harmony import */ var src_app_public_create_loadslips_error_popup_create_loadslips_error_popup_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/public/create-loadslips-error-popup/create-loadslips-error-popup.component */ "./src/app/public/create-loadslips-error-popup/create-loadslips-error-popup.component.ts");
/* harmony import */ var _jit_create_load_slip_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./jit-create-load-slip.component */ "./src/app/jit/jit-create-load-slip/jit-create-load-slip.component.ts");
...
var routes = [
    { path: '', component: _jit_create_load_slip_component__WEBPACK_IMPORTED_MODULE_11__["JitCreateLoadSlipComponent"] },
    { path: ':loadslipId', component: _jit_create_load_slip_component__WEBPACK_IMPORTED_MODULE_11__["JitCreateLoadSlipComponent"] },
    { path: ':loadslipId/:viewType', component: _jit_create_load_slip_component__WEBPACK_IMPORTED_MODULE_11__["JitCreateLoadSlipComponent"] },
];
var JitCreateLoadSlipModule = /** @class */ (function () {
    function JitCreateLoadSlipModule() {
    }
    JitCreateLoadSlipModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                src_app_public_share_module_share_module_module__WEBPACK_IMPORTED_MODULE_7__["ShareModuleModule"],
                src_app_date_pipe_shared_module__WEBPACK_IMPORTED_MODULE_12__["CustomDatePipeModule"]
            ],
            declarations: [
                _jit_create_load_slip_component__WEBPACK_IMPORTED_MODULE_11__["JitCreateLoadSlipComponent"]
            ],
            entryComponents: [
                _jit_create_load_slip_component__WEBPACK_IMPORTED_MODULE_11__["JitCreateLoadSlipComponent"],
                src_app_public_loadslip_cancel_popup_loadslip_cancel_popup_component__WEBPACK_IMPORTED_MODULE_8__["LoadslipCancelPopupComponent"],
                src_app_public_loadslip_success_dialog_loadslip_success_dialog_component__WEBPACK_IMPORTED_MODULE_9__["LoadslipSuccessDialogComponent"],
                src_app_public_create_loadslips_error_popup_create_loadslips_error_popup_component__WEBPACK_IMPORTED_MODULE_10__["CreateLoadslipsErrorPopupComponent"],
            ]
        })
    ], JitCreateLoadSlipModule);
    return JitCreateLoadSlipModule;
}());
...
//# sourceMappingURL=jit-jit-create-load-slip-jit-create-load-slip-module.js.map