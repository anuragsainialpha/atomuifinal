(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["fgs-operations-EWM-ewm-create-loadslip-ewm-create-loadslip-module"],{

/***/ "./src/app/fgs-operations/EWM/ewm-create-loadslip/ewm-create-loadslip.component.html":
/*!*******************************************************************************************!*\
  !*** ./src/app/fgs-operations/EWM/ewm-create-loadslip/ewm-create-loadslip.component.html ***!
  \*******************************************************************************************/
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2Zncy1vcGVyYXRpb25zL0VXTS9ld20tY3JlYXRlLWxvYWRzbGlwL2V3bS1jcmVhdGUtbG9hZHNsaXAuY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/fgs-operations/EWM/ewm-create-loadslip/ewm-create-loadslip.component.ts":
/*!*****************************************************************************************!*\
  !*** ./src/app/fgs-operations/EWM/ewm-create-loadslip/ewm-create-loadslip.component.ts ***!
  \*****************************************************************************************/
/*! exports provided: EwmCreateLoadslip */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EwmCreateLoadslip", function() { return EwmCreateLoadslip; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var ngx_toastr__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ngx-toastr */ "./node_modules/ngx-toastr/fesm5/ngx-toastr.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var src_app_public_loadslip_cancel_popup_loadslip_cancel_popup_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/public/loadslip-cancel-popup/loadslip-cancel-popup.component */ "./src/app/public/loadslip-cancel-popup/loadslip-cancel-popup.component.ts");
...
/* harmony import */ var src_app_public_loadslip_success_dialog_loadslip_success_dialog_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/public/loadslip-success-dialog/loadslip-success-dialog.component */ "./src/app/public/loadslip-success-dialog/loadslip-success-dialog.component.ts");
/* harmony import */ var src_app_public_create_loadslips_error_popup_create_loadslips_error_popup_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/public/create-loadslips-error-popup/create-loadslips-error-popup.component */ "./src/app/public/create-loadslips-error-popup/create-loadslips-error-popup.component.ts");
/* harmony import */ var src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/services/api/apiservice.service */ "./src/app/services/api/apiservice.service.ts");
...
var EwmCreateLoadslip = /** @class */ (function () {
    function EwmCreateLoadslip(service, router, ActivatedRoute, toastr, dialog) {
    ...
    EwmCreateLoadslip.prototype.ngOnInit = function () {
    ...
    // Check multi stop 
    EwmCreateLoadslip.prototype.checkMultiStop = function () {
    ...
    EwmCreateLoadslip.prototype.getElrFlag = function () {
        var _this = this;
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.getElrFlag + "?loadslipId=" + this.loadslipID).subscribe(function (response) {
    ...
    EwmCreateLoadslip.prototype.setLrButton = function () {
    ...
    // Generate Lr number
    EwmCreateLoadslip.prototype.generateLrNum = function () {
        var _this = this;
        console.log("**** generateLrNum");
        this.isLoading = true;
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.generateLrNum + "?loadslipId=" + this.loadslipID).subscribe(function (response) {
    ...
    EwmCreateLoadslip.prototype.downloadLoadReceipt = function () {
        var _this = this;
        this.isLoading = true;
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.printLoadReceipt + "?loadslipId=" + this.loadslipID).subscribe(function (response) {
            if (response['statusCode'] == 200) {
    ...
    EwmCreateLoadslip.prototype.getLoadSlipDetailsById = function () {
        var _this = this;
        this.isLoading = true;
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.getLoadSlipDetailsByID + "/" + this.loadslipID).subscribe(function (response) {
            if (response['statusCode'] == 200) {
                var responseData = response['data'];
    ...
    EwmCreateLoadslip.prototype.getLoadslipPlanByDestination = function (responseData, destination, category) {
        var _this = this;
        this.isLoading = true;
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.getLoadSlipsPlans + "?destLoc=" + destination + "&loadslipId=" + this.loadslipID + "&itemCategory=" + category).subscribe(function (response) {
    ...
    EwmCreateLoadslip.prototype.destinationwisePlans = function (destination) {
        var _this = this;
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.getLoadSlipsPlans + "?destLoc=" + destination + "&loadslipId=" + this.loadslipID).subscribe(function (response) {
            console.log(response);
            if (response['statusCode'] == 200) {
                var repsonseData = response['data'];
                // destination related plans list
    ...
    EwmCreateLoadslip.prototype.setLoadslipDatatableData = function (responseData) {
        var _this = this;
        this.loadSlipData = [];
    ...
    EwmCreateLoadslip.prototype.getLoadSlipUtilazationFromServer = function (truckNumber, truckType, shipmentNumber) {
        var _this = this;
        this.isLoading = true;
        var data = {
        ...
        this.service.post_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.getLoadSlipUtlizations, data).subscribe(function (response) {
            console.log(response);
            if (response['statusCode'] == 200) {
    ...
    EwmCreateLoadslip.prototype.getDestinationList = function () {
        var _this = this;
        this.isLoading = true;
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.getOpenDestinations).subscribe(function (response) {
            console.log(response);
            if (response['statusCode'] == 200) {
    ...
    EwmCreateLoadslip.prototype.getTrucksList = function (destination, category, filterType) {
    ...
    EwmCreateLoadslip.prototype.getTruckTypesForDest = function (destination) {
        var _this = this;
        if (destination) {
            this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.getMasterTruckTypesWithDest + '?sourceLoc=' + this.userSource + '&destLoc=' + destination).subscribe(function (response) {
                if (response['statusCode'] == 200) {
    ...
    EwmCreateLoadslip.prototype.getLoadSlipsPlansData = function (dest, category, filterType) {
        var _this = this;
        this.isLoading = true;
        ...
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.getLoadSlipsPlans + "?destLoc=" + destination + "&itemCategory=" + cat + "&loadslipId=" + loadslipId).subscribe(function (response) {
            console.log(response);
            if (response['statusCode'] == 200) {
                var repsonseData = response['data'];
    ...
    //
    EwmCreateLoadslip.prototype.getBOMbatchCode = function (key) {
        console.log(key);
        return this.marketSegmentMap[key];
    };
    // Update Angular data tablesd
    EwmCreateLoadslip.prototype.updateValue = function (event, cell, rowIndex, row) {
    ...
    EwmCreateLoadslip.prototype.calculateMaterialWeight = function (row) {
        var _this = this;
    ...
    EwmCreateLoadslip.prototype.getLoadSlipUtilazations = function (truckNumber) {
        var _this = this;
    ...
    EwmCreateLoadslip.prototype.ManualTTE_Weight_volume_Calculation = function () {
        var _this = this;
        this.totalLoadedQty = 0;
        this.itemLevelTotalTTE = 0;
        this.itemLevelTotalWeight = 0;
    ...
    EwmCreateLoadslip.prototype.eventCall = function (loadSlipID, eventType) {
        var _this = this;
        ...
        if (loadSlipID) {
            ...
            if ((eventType == 'CONFIRM') && !this.truckType) {
                ...
                this.service.post_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.updateLoadSlipevent, data).subscribe(function (response) {
                    var stoSTOMessage = '';
    ...
    EwmCreateLoadslip.prototype.saveAsDraft_Print_trigger = function (eventType) {
        var _this = this;
        this.isLoading = true;
        this.category = [];
        var linenumber;
        ...
        if (Is_Qty_entered != 0) {
            ...
            if (!this.loadSlipData.some(function (item) { return (item.BATCH_CODE == null || item.BATCH_CODE == ""); })) {
                if (this.checkMultiStop()) {
                    var HTTPAPI = src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.multipleDropLoadSlip;
                    this.loadslipsave(saveasDraftData, HTTPAPI);
                }
                else {
                    var HTTPAPI = src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.loadslidSaveasDraft;
                    this.loadslipsave(saveasDraftData, HTTPAPI);
                }
            }
            else {
    ...
    EwmCreateLoadslip.prototype.loadslipsave = function (saveasDraftData, HTTPAPI) {
        var _this = this;
    ...
    EwmCreateLoadslip.prototype.openloadsliperrorPopup = function (errorList) {
        var dialogRef = this.dialog.open(src_app_public_create_loadslips_error_popup_create_loadslips_error_popup_component__WEBPACK_IMPORTED_MODULE_7__["CreateLoadslipsErrorPopupComponent"], {
            data: errorList,
            disableClose: true
        });
    };
    // Show loadslipId with success POPUP
    EwmCreateLoadslip.prototype.showLoadslipInModal = function (value, typeofevent, IsUpdate, response) {
        var dialogRef = this.dialog.open(src_app_public_loadslip_success_dialog_loadslip_success_dialog_component__WEBPACK_IMPORTED_MODULE_6__["LoadslipSuccessDialogComponent"], {
    ...
    EwmCreateLoadslip.prototype.cancelLoadslipCreation = function () {
        var _this = this;
        this.isLoading = true;
        var dialogRef = this.dialog.open(src_app_public_loadslip_cancel_popup_loadslip_cancel_popup_component__WEBPACK_IMPORTED_MODULE_4__["LoadslipCancelPopupComponent"], { disableClose: true });
    ...
    EwmCreateLoadslip.prototype.downloadLoadslip = function () {
        var _this = this;
        this.isLoading = true;
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.printLoadslip + "?loadslipId=" + this.loadslipID).subscribe(function (response) {
            if (response['statusCode'] == 200) {
                var responseData = response['data'];
                var linkSource = 'data:application/pdf;base64,' + responseData;
                var element = document.createElement('a');
    ...
    EwmCreateLoadslip.prototype.sendForBarcode = function () {
        var _this = this;
        // check whether loadslip created or not
        if (this.loadslipID) {
            this.isLoading = true;
            var data = {};
            this.service.post_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.sendToSAPForCodeScan + "/" + this.loadslipID, data).subscribe(function (response) {
                if (response['statusCode'] == 200) {
                    _this.isLoading = false;
                    _this.toastr.success(response['message']);
    ...
    EwmCreateLoadslip.prototype.loadslipOnSameTruckNavigation = function () {
        var _this = this;
        if (this.shipmentNumber) {
            if (this.IS_Truck_Part_of_Loadslip) {
                this.isLoading = true;
                this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.isLsOnSameTruckAllowed + "?shipmentId=" + this.shipmentNumber).subscribe(function (response) {
                    if (response['statusCode'] == 200) {
                        _this.isLoading = false;
    ...
    EwmCreateLoadslip.prototype.shareTruckDestinationList = function () {
        var _this = this;
        if (this.shipmentNumber) {
            if (this.IS_Truck_Part_of_Loadslip) {
                this.isLoading = true;
                this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.shareTruckDestions).subscribe(function (response) {
                    if (response['statusCode'] == 200) {
    ...
    EwmCreateLoadslip.prototype.shareTruck = function () {
        var _this = this;
        this.isLoading = true;
        if (this.shareTruckLocation) {
            var data = {};
            this.service.post_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.shareTruck + "?shipmentId=" + this.shipmentNumber + '&pickupLoc=' + this.shareTruckLocation, data).subscribe(function (response) {
                if (response['statusCode'] == 200) {
                    _this.toastr.success(response['message']);
    ...
    EwmCreateLoadslip.prototype.getvariants = function () {
        var _this = this;
        //this.isLoading = true;
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.getVariants).subscribe(function (response) {
            if (response['statusCode'] == 200) {
                var responseData = response['data'];
    ...
    EwmCreateLoadslip.prototype.getActualTruckTypeList = function () {
        var _this = this;
        this.actualTruckTypeList = [];
        //this.isLoading = true;
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.getMasterTruckstype).subscribe(function (response) {
    ...
    EwmCreateLoadslip.prototype.split = function (data) {
        console.log(data);
    ...
    EwmCreateLoadslip.prototype.deleteRow = function (data) {
        var _this = this;
    ...
    EwmCreateLoadslip.prototype.add = function (data) {
        console.log(data);
        var rowData = __assign({}, data);
    ...
    EwmCreateLoadslip.prototype.IsIntiger = function (n) {
        return n % 1 === 0;
    };
    EwmCreateLoadslip.prototype.stosoDelete = function (loadslip) {
        var _this = this;
        this.isLoading = true;
        this.service.get_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.stosoDelete + "?loadslipId=" + loadslip).subscribe(function (response) {
            if (response['statusCode'] == 200) {
                var responsedata = response['data'];
                _this.sostoNumber = responsedata.sostoNumber;
                _this.STOSONumber = responsedata.sostoNumberVal;
    ...
    EwmCreateLoadslip.prototype.is_Role_RDC = function () {
        if (this.service.checkRole() == this.roles.rdc_PLN) {
            return true;
        }
        else {
    ...
    EwmCreateLoadslip.prototype.defaultTruckData = function () {
        this.actualTruckType = '';
        this.variant_ONE = '';
    };
    EwmCreateLoadslip.prototype.openedChange = function (opened, dest, category, typefilter) {
        console.log(opened);
        if (!opened) {
    ...
    // Print Excel
    EwmCreateLoadslip.prototype.export = function () {
        var _this = this;
        this.isLoading = true;
        this.service.get_service_DownLoadExcel(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"].apisList.printLoadslip + '?loadslipId=' + this.loadslipID + '&excel=' + true).subscribe(function (response) {
            if (response) {
    ...
    ], EwmCreateLoadslip.prototype, "categorySelect", void 0);
    EwmCreateLoadslip = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-ewm-create-loadslip',
            template: __webpack_require__(/*! ./ewm-create-loadslip.component.html */ "./src/app/fgs-operations/EWM/ewm-create-loadslip/ewm-create-loadslip.component.html"),
            styles: [__webpack_require__(/*! ./ewm-create-loadslip.component.scss */ "./src/app/fgs-operations/EWM/ewm-create-loadslip/ewm-create-loadslip.component.scss")]
        }),
        __metadata("design:paramtypes", [src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_8__["ApiserviceService"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"], ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"], _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"]])
    ], EwmCreateLoadslip);
    return EwmCreateLoadslip;
}());
...
/*!**************************************************************************************!*\
  !*** ./src/app/fgs-operations/EWM/ewm-create-loadslip/ewm-create-loadslip.module.ts ***!
  \**************************************************************************************/
/*! exports provided: EwmCreateLoadslipModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EwmCreateLoadslipModule", function() { return EwmCreateLoadslipModule; });
...
/* harmony import */ var src_app_public_loadslip_cancel_popup_loadslip_cancel_popup_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/public/loadslip-cancel-popup/loadslip-cancel-popup.component */ "./src/app/public/loadslip-cancel-popup/loadslip-cancel-popup.component.ts");
...
/* harmony import */ var src_app_angular_material__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/angular-material */ "./src/app/angular-material.ts");
/* harmony import */ var src_app_public_loader_loader_shared_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/public/loader/loader-shared.module */ "./src/app/public/loader/loader-shared.module.ts");
/* harmony import */ var _ewm_create_loadslip_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ewm-create-loadslip.component */ "./src/app/fgs-operations/EWM/ewm-create-loadslip/ewm-create-loadslip.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: '', component: _ewm_create_loadslip_component__WEBPACK_IMPORTED_MODULE_12__["EwmCreateLoadslip"] },
    { path: ':loadslipId', component: _ewm_create_loadslip_component__WEBPACK_IMPORTED_MODULE_12__["EwmCreateLoadslip"] },
    { path: ':loadslipId/:viewType', component: _ewm_create_loadslip_component__WEBPACK_IMPORTED_MODULE_12__["EwmCreateLoadslip"] },
    { path: ':shipmentId/:truckNumber/:typeOfTruck/:variant1/:actualTruckType', component: _ewm_create_loadslip_component__WEBPACK_IMPORTED_MODULE_12__["EwmCreateLoadslip"] }
];
var EwmCreateLoadslipModule = /** @class */ (function () {
    function EwmCreateLoadslipModule() {
    }
    EwmCreateLoadslipModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                [_angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes)],
                _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"],
                src_app_angular_material__WEBPACK_IMPORTED_MODULE_10__["customMaterialModule"],
                src_app_public_loader_loader_shared_module__WEBPACK_IMPORTED_MODULE_11__["LoaderModule"],
            ...
            declarations: [
                _ewm_create_loadslip_component__WEBPACK_IMPORTED_MODULE_12__["EwmCreateLoadslip"],
            ],
            entryComponents: [
                _ewm_create_loadslip_component__WEBPACK_IMPORTED_MODULE_12__["EwmCreateLoadslip"],
                src_app_public_loadslip_cancel_popup_loadslip_cancel_popup_component__WEBPACK_IMPORTED_MODULE_6__["LoadslipCancelPopupComponent"],
                src_app_public_loadslip_success_dialog_loadslip_success_dialog_component__WEBPACK_IMPORTED_MODULE_7__["LoadslipSuccessDialogComponent"],
                src_app_public_create_loadslips_error_popup_create_loadslips_error_popup_component__WEBPACK_IMPORTED_MODULE_8__["CreateLoadslipsErrorPopupComponent"],
            ]
        })
    ], EwmCreateLoadslipModule);
    return EwmCreateLoadslipModule;
}());
...
//# sourceMappingURL=fgs-operations-EWM-ewm-create-loadslip-ewm-create-loadslip-module.js.map