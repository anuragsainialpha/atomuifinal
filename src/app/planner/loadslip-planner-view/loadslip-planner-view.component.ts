...
@Component({
  ...
  templateUrl: './loadslip-planner-view.component.html',
  styleUrls: ['./loadslip-planner-view.component.scss']
})
export class LoadslipPlannerViewComponent implements OnInit {
