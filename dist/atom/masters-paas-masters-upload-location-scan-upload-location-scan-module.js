(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["masters-paas-masters-upload-location-scan-upload-location-scan-module"],{

/***/ "./src/app/masters/paas-masters/upload-location-scan/upload-location-scan.component.html":
/*!***********************************************************************************************!*\
  !*** ./src/app/masters/paas-masters/upload-location-scan/upload-location-scan.component.html ***!
  \***********************************************************************************************/
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21hc3RlcnMvcGFhcy1tYXN0ZXJzL3VwbG9hZC1sb2NhdGlvbi1zY2FuL3VwbG9hZC1sb2NhdGlvbi1zY2FuLmNvbXBvbmVudC5zY3NzIn0= */"

/***/ }),

/***/ "./src/app/masters/paas-masters/upload-location-scan/upload-location-scan.component.ts":
/*!*********************************************************************************************!*\
  !*** ./src/app/masters/paas-masters/upload-location-scan/upload-location-scan.component.ts ***!
  \*********************************************************************************************/
/*! exports provided: UploadLocationScanComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UploadLocationScanComponent", function() { return UploadLocationScanComponent; });
...
var UploadLocationScanComponent = /** @class */ (function () {
    function UploadLocationScanComponent(router, acitvatedRoute, toastr, service, dialog) {
        this.router = router;
    ...
    UploadLocationScanComponent.prototype.ngOnInit = function () {
        localStorage.setItem("userMenu", "create-freight");
    };
    UploadLocationScanComponent.prototype.onFileChange = function (event) {
        var _this = this;
        // this.ErrorData="";
        this.gotResponse = false;
        this.IsErrorLog = false;
        ...
        if (this.file['type'] == 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet') {
            ...
            fileReader_1.onload = function (e) {
                ...
                var locationData = {
                    locationScanList: importedItemFileList
                };
                console.log("importedItemFileList", importedItemFileList);
                console.log("POSTING DATA ", JSON.stringify(locationData));
                _this.service.post_service(src_app_services_api_apiservice_service__WEBPACK_IMPORTED_MODULE_4__["ApiserviceService"].apisList.updateLocationScan, locationData).subscribe(function (response) {
    ...
    UploadLocationScanComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-upload-location-scan',
            template: __webpack_require__(/*! ./upload-location-scan.component.html */ "./src/app/masters/paas-masters/upload-location-scan/upload-location-scan.component.html"),
            styles: [__webpack_require__(/*! ./upload-location-scan.component.scss */ "./src/app/masters/paas-masters/upload-location-scan/upload-location-scan.component.scss")]
        }),
    ...
    ], UploadLocationScanComponent);
    return UploadLocationScanComponent;
}());
...
/*!******************************************************************************************!*\
  !*** ./src/app/masters/paas-masters/upload-location-scan/upload-location-scan.module.ts ***!
  \******************************************************************************************/
/*! exports provided: UploadLocationScanModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UploadLocationScanModule", function() { return UploadLocationScanModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _upload_location_scan_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./upload-location-scan.component */ "./src/app/masters/paas-masters/upload-location-scan/upload-location-scan.component.ts");
...
var routes = [
    { path: '', component: _upload_location_scan_component__WEBPACK_IMPORTED_MODULE_2__["UploadLocationScanComponent"] }
];
var UploadLocationScanModule = /** @class */ (function () {
    function UploadLocationScanModule() {
    }
    UploadLocationScanModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_upload_location_scan_component__WEBPACK_IMPORTED_MODULE_2__["UploadLocationScanComponent"]]
        })
    ], UploadLocationScanModule);
    return UploadLocationScanModule;
}());
...
//# sourceMappingURL=masters-paas-masters-upload-location-scan-upload-location-scan-module.js.map