...
@Component({
  ...
  templateUrl: './upload-mt-sap-truck-type.component.html',
  styleUrls: ['./upload-mt-sap-truck-type.component.scss']
})
export class UploadMtSapTruckTypeComponent implements OnInit {
