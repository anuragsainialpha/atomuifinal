...
@Component({
  ...
  templateUrl: './upload-mt-batch-codes.component.html',
  styleUrls: ['./upload-mt-batch-codes.component.scss']
})
export class UploadMtBatchCodesComponent implements OnInit {
   ...
   this.gotResponse=false;
    ...
    if (this.file['type'] == 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet') {
      ...
      //  delete myObject.regex;
        ...
        this.service.post_service(ApiserviceService.apisList.addOrUploadMtBatchCodes, filedata).subscribe(response => {
