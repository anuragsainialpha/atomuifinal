...
@Component({
  ...
  templateUrl: './um-user-association.component.html',
  styleUrls: ['./um-user-association.component.scss']
})
export class UmUserAssociationComponent implements OnInit {
  ...
  userIdu: any = "";
  associationIdentifieru: any = "";
  associationValueu: any = "";
  uaIdu: any = "";


  userIdf: any = "";
  associationIdentifierf: any = "";
  associationValuef: any = "";
  ...
  doSearch(data) {
    ...
    this.service.post_service(ApiserviceService.apisList.getUserAssociation, data).subscribe(response => {
  ...
  updateForm(form: NgForm) {
    ...
    this.service.post_service(ApiserviceService.apisList.updateUserAssociation, data).subscribe(response => {
    ...
    if (this.responseItemsList.length > 0) {
      ...
      this.service.post_service(ApiserviceService.apisList.getUserAssociation, data).subscribe(response => {
        ...
        if (response['statusCode'] == 200) {
          ...
          XLSX.writeFile(workBook, 'User Association.xlsx');
          this.isLoading = false;
        } else {
          this.toastr.error(response['message'] ? response['message'] : 'Something went wrong...', 'Error!');
          this.isLoading = false;
