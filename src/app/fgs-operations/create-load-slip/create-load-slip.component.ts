...
export class CreateLoadSlipComponent implements OnInit {
  ...
  truckCapacity: any;
  totalMaterialWeightFlag: any;
  goApprovalReason: any;
  goApprovalReasonList = [];
  files: File;
  binary: any;
  ...
  getLoadSlipDetailsById() {
    ...
    this.service.get_service(ApiserviceService.apisList.getLoadSlipDetailsByID + "/" + this.loadslipID).subscribe(response => {
      if (response['statusCode'] == 200) {
        ...
        this.truckCapacity = responseData.truckWeightCapacity;
       ...
       // this.truckCapacity = responseData.truckCapacity;
        ...
        this.goApprovalReason = responseData.goApprovalReason;
        console.log("Response Go Approval", responseData.goApprovalReason, "and local variable: ", this.goApprovalReason );
      } else {
        this.isLoading = false;
  ...
  updateValue(event, cell, rowIndex, row) {
    ...
    else this.totalMaterialWeightFlag = '';
  ...
  getLoadSlipUtilazations(truckNumber) {
    ...
    if (truckNumber) {
      ...
      let data = {
        ...
        //truckCapaity: this.loadslipUtilizationData
...
let domainName = 'ATL';
     let documentXid = this.loadslipID;
     let datecurr = formatDate(new Date(), 'yyyy-MM-dd hh24-mi-ss', 'en');
     reader.onload = () => {
      console.log(reader.result);
      let resultString = reader.result as string;
      var documentData = 
     {
         "documentXid": this.shipmentNumber + "-" + datecurr,
         "domainName": "ATL",
         "ownerDataQueryTypeGid": "SHIPMENT",
         "ownerObjectGid": "ATL." + this.shipmentNumber,
         "documentType": "BLOB",
         "contents":{ "items": [ {"documentContentGid":"ATL." + this.shipmentNumber  + "-" + datecurr,
         "domainName":"ATL",
         "isAwaitingVirusCheck": false,
          "blobContent":resultString.split(',')[1]
...
//    '<otm:Transmission xmlns:otm="http://xmlns.oracle.com/apps/otm/transmission/v6.4" xmlns:gtm="http://xmlns.oracle.com/apps/gtm/transmission/v6.4"><otm:TransmissionHeader><otm:SenderTransmissionNo>ATOM</otm:SenderTransmissionNo></otm:TransmissionHeader><otm:TransmissionBody><otm:GLogXMLElement><otm:Document><otm:DocumentGid><otm:Gid><otm:DomainName>ATL</otm:DomainName><otm:Xid>'+this.shipmentNumber + '-' + datecurr +'</otm:Xid></otm:Gid></otm:DocumentGid><otm:TransactionCode>IU</otm:TransactionCode><otm:DocumentOwner><otm:DataQueryTypeGid><otm:Gid><otm:Xid>SHIPMENT</otm:Xid></otm:Gid></otm:DataQueryTypeGid><otm:ObjectGid><otm:Gid><otm:DomainName>ATL</otm:DomainName><otm:Xid>'+this.shipmentNumber + '-' + datecurr +'</otm:Xid></otm:Gid></otm:ObjectGid></otm:DocumentOwner><otm:DocumentContent><otm:DocContentBinary></otm:DocContentBinary></otm:DocumentContent></otm:Document></otm:GLogXMLElement></otm:TransmissionBody></otm:Transmission>'
     ...
     this.service.post_otm_service(url, documentData).subscribe(response => {
      if (response['statusCode'] == 200 && response["data"] == 'Y') {
        //|| response["data"] == 'N'
