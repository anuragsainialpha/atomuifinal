...
@Component({
  ...
  templateUrl: './upload-location-scan.component.html',
  styleUrls: ['./upload-location-scan.component.scss']
})
export class UploadLocationScanComponent implements OnInit {
   ...
   this.gotResponse=false;
    ...
    if (this.file['type'] == 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet') {
      ...
      //  delete myObject.regex;
        ...
        this.service.post_service(ApiserviceService.apisList.updateLocationScan, locationData).subscribe(response => {
