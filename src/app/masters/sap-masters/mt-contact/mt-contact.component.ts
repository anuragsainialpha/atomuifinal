...
@Component({
  ...
  templateUrl: './mt-contact.component.html',
  styleUrls: ['./mt-contact.component.scss']
})
...
locationIds:any[]=["01AP","01AS","01BR","01CG"];  
userRoleIds:any[]=["ADMIN","CHA","CLS","FPL"];
