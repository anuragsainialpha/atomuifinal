...
@Component({
  ...
  templateUrl: './upload-mt-elr.component.html',
  styleUrls: ['./upload-mt-elr.component.scss']
})
export class UploadMtElrComponent implements OnInit {
   ...
   this.gotResponse=false;
    ...
    if (this.file['type'] == 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet') {
      ...
      //  delete myObject.regex;
        ...
        this.service.post_service(ApiserviceService.apisList.uploadMtElr, filedata).subscribe(response => {
