...
@Component({
  ...
  templateUrl: './upload-mt-material-group.component.html',
  styleUrls: ['./upload-mt-material-group.component.scss']
})
export class UploadMtMaterialGroupComponent implements OnInit {
   ...
   this.gotResponse=false;
    ...
    if (this.file['type'] == 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet') {
      ...
      //  delete myObject.regex;
        ...
        this.service.post_service(ApiserviceService.apisList.addOrUploadMtMaterialGroup, uploadedData).subscribe(response => {
