...
@Component({
  ...
  templateUrl: './ct-otm-freight-basis.component.html',
  styleUrls: ['./ct-otm-freight-basis.component.scss']
})
export class CtOtmFreightBasisComponent implements OnInit {
...
doSearch(data) {
  ...
  this.responseItemsList =[];
    ...
    this.service.post_service(ApiserviceService.apisList.getCtOtmFreightBasis, data).subscribe(response => {
