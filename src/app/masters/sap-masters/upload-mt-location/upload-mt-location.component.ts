...
@Component({
  ...
  templateUrl: './upload-mt-location.component.html',
  styleUrls: ['./upload-mt-location.component.scss']
})
export class UploadMtLocationComponent implements OnInit {
   ...
   this.gotResponse=false;
    ...
    if (this.file['type'] == 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet') {
      ...
      //  delete myObject.regex;
        ...
        this.service.post_service(ApiserviceService.apisList.updateMtLocation, filedata).subscribe(response => {
